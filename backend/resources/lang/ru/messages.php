...
return [
    ...
    'set_permission_role' => 'Роли :role было назначено разрешение :permission.',
    'take_off_permission_role' => 'С роли :role было снято разрешение :permission.',
    'set_user_role' => 'Роль :role была назначена на пользователя :user.',
    'remove_role_in_user' => 'Роль :role была удалена с юзера :user.',
    'set_permission_user' => 'Разрешение :permission установлено пользователю :user.',
    'delete_permission_user'   => 'Разрешение :permission убрано с пользователя :user.',
    'filled_lecturers' => 'В систему было добавлено :count преподавателей.',
    'not_access'               => 'У вас нет доступа к этой части системы!',
    'template_create' => 'Шаблон был создан!',
];
